...
<head>
  ...
  <!-- Favicons -->
  <!-- <link href="="<?= base_url()?>niceadmin/assets/vendor/simple-datatables/style.css" /img/favicon.png" rel="icon"> -->
  <!-- <link href="="<?= base_url()?>niceadmin/assets/vendor/simple-datatables/style.css" /img/apple-touch-icon.png" rel="apple-touch-icon"> -->
